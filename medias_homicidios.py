...
def get_medias(df_dados_brutos):
    ...
    # onde valor é a taxa_homicidio e o peso é pouplacao
    # calcular a média ponderada de homicidios onde o
...
def estimativas_variabilidade(dados_brutos, media):
   ...
   """
    ...
    # variancia (ddof = delta degree of freedom)
    ...
    df_desvios_individuais = pd.DataFrame({
        ...
        'Desvio (taxa homicidios - media)': desvios,
