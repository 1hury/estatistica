# venv\Scripts\activate - ativar o venv pelo terminal || Obs: estar dentro da pasta desejada
import pandas as pd
...
def gerar_dados_brutos(num_registros):
    ...
    while len(dados_brutos) < num_registros:
        ...
        if nome_cidade not in lista_cidades:
            ...
            # gerar taxa de homicídio entre 1.0 e 15.0 arredondado e com uma casa decimal
